...
export default {
	...
	async execute(client, interaction, otherData) {
		...
		const resp = await interaction.reply({
			embeds: [
				new EmbedBuilder()
					.setTitle("AntiRaid Forums Help")
					.setURL("https://antiraid.xyz/forums")
					.setThumbnail("https://antiraid.xyz/logo.webp")
					.setColor("Random")
					.setDescription(
						"Hello, there. Do you need help with AntiRaid Forums? Well, look no further! Here are a few commands that you can use to get you started!"
					)
